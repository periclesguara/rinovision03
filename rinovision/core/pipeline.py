...
STATES = [
    ...
    "AI_VIDEO_JOB_QUEUED",
    "AI_VIDEO_JOB_IN_PROGRESS",
    "AI_VIDEO_JOB_COMPLETED",
    "AI_VIDEO_JOB_FAILED",
    "AI_VIDEO_DOWNLOADED",
    "AI_SOCIAL_PACKAGE_CREATED",
    "AI_VIDEO_REQUESTED",
...
TRANSITIONS = {
    "PROJECT_CREATED": {"MEDIA_IMPORTED", "CAPTURE_READY", "AI_BRIEF_CREATED", "AI_SCRIPT_CREATED", "EDIT_PLAN_CREATED", "FAILED"},
    ...
    "AI_BRIEF_CREATED": {"AI_SCRIPT_CREATED", "FAILED"},
    "AI_PROMPTS_CREATED": {"AI_PROVIDER_SELECTED", "AI_VIDEO_REQUESTED", "FAILED"},
    "AI_PROVIDER_SELECTED": {"AI_VIDEO_JOB_CREATED", "FAILED"},
    "AI_VIDEO_JOB_CREATED": {"AI_VIDEO_JOB_QUEUED", "FAILED"},
    "AI_VIDEO_JOB_QUEUED": {"AI_VIDEO_JOB_IN_PROGRESS", "AI_VIDEO_JOB_COMPLETED", "AI_VIDEO_JOB_FAILED", "FAILED"},
    "AI_VIDEO_JOB_IN_PROGRESS": {"AI_VIDEO_JOB_COMPLETED", "AI_VIDEO_JOB_FAILED", "FAILED"},
    "AI_VIDEO_JOB_COMPLETED": {"AI_VIDEO_DOWNLOADED", "FAILED"},
    "AI_VIDEO_JOB_FAILED": {"FAILED"},
    "AI_VIDEO_DOWNLOADED": {"AI_VIDEO_IMPORTED_FOR_EDITING", "FAILED"},
    "AI_SOCIAL_PACKAGE_CREATED": {"QC_READY", "EXPORT_READY", "FAILED"},
    "AI_VIDEO_REQUESTED": {"AI_VIDEO_GENERATED_RAW", "FAILED"},
    "AI_VIDEO_GENERATED_RAW": {"AI_VIDEO_IMPORTED_FOR_EDITING", "FAILED"},
    "AI_VIDEO_IMPORTED_FOR_EDITING": {"EDIT_PLAN_CREATED", "AI_SOCIAL_PACKAGE_CREATED", "FAILED"},
    "EDIT_PLAN_CREATED": {"VIDEO_EDITED", "THUMBNAIL_GENERATED", "AI_SOCIAL_PACKAGE_CREATED", "QC_READY", "FAILED"},
